...
class FragmentHome : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        brandProductrecyclerView?.addItemDecoration(
            SpaceDecoration(
                resources.getDimensionPixelSize(
                    R.dimen.provider_name_horizontal_magin
                )
            )
        )
        ...
        recyclerDetailsProducts?.layoutManager =
        ...
        recyclerViewRandom?.layoutManager =
            LinearLayoutManager(requireContext(), LinearLayoutManager.HORIZONTAL, false)
        ...
        recyclerView?.adapter = RandomAdapter(Feature.getfeature())
    }
}
